...
Daily limit: 78% remaining`},{id:"review",command:"/review",zhName:"\u4EE3\u7801\u5BA1\u67E5",zhDescription:"\u8BA9 Claude Code \u5BA1\u67E5\u5F53\u524D\u7684\u4EE3\u7801\u6539\u52A8\uFF0C\u627E\u51FA\u6F5C\u5728\u95EE\u9898\u5E76\u7ED9\u51FA\u6539\u8FDB\u5EFA\u8BAE\u3002\u76F8\u5F53\u4E8E\u4E00\u4E2A AI code reviewer\u3002",scenario:"\u4F60\u5199\u5B8C\u4E86\u4E00\u4E2A\u65B0\u529F\u80FD\uFF0C\u60F3\u5728\u63D0\u4EA4 PR \u4E4B\u524D\u8BA9 Claude Code \u5E2E\u4F60\u68C0\u67E5\u4EE3\u7801\u8D28\u91CF\u3002\u4F60\u8BE5\u7528\u4EC0\u4E48\u547D\u4EE4\uFF1F",wrongChoices:["/check \u2014 \u8FD0\u884C\u68C0\u67E5","/lint \u2014 \u4EE3\u7801\u683C\u5F0F\u5316","/audit \u2014 \u5B89\u5168\u5BA1\u8BA1"],terminalResponse:`Reviewing staged changes...
  ...
  `,e.querySelectorAll("[data-world]").forEach(i=>{i.addEventListener("click",()=>{let o=i.getAttribute("data-world");o&&y.isWorldUnlocked(parseInt(o))&&z.navigate(`/world/${o}`)})}),e.querySelector("#btn-glossary")?.addEventListener("click",()=>z.navigate("/glossary")),e.querySelector("#btn-profile")?.addEventListener("click",()=>z.navigate("/profile")),e.querySelector("#btn-review")?.addEventListener("click",()=>z.navigate("/review"))}function w(e,t,n){let l=y.getStreak();return`
    <div class="header">
  ...
  `}function le(e,t){let n=ne(t),l=V[t]||[],i=y.getWorldCompletion(t),o=y.get().worlds[t];e.innerHTML=`
    ...
    <div class="screen">
      ...
      <div style="display:flex;flex-direction:column;gap:var(--space-sm);">
        ${l.map((s,r)=>{let a=y.isLevelUnlocked(t,r),p=o?.levelsCompleted.includes(r),c=o?.stars[r]||0;return`
            <div class="card" data-level="${r}" style="${a?"cursor:pointer;":"opacity:0.4;pointer-events:none;"}">
              <div style="display:flex;align-items:center;gap:var(--space-md);">
                ...
                <div class="stars">
                  ${[1,2,3].map(d=>`<span class="star ${d<=c?"earned":""}">\u2605</span>`).join("")}
                </div>
              </div>
            </div>
          `}).join("")}
  ...
  `}function P(e,t,n,l){let i=!1,o=e.querySelectorAll(".option-btn");o.forEach((s,r)=>{s.addEventListener("click",()=>{if(i)return;i=!0;let a=parseInt(s.dataset.index||String(r)),p=a===t;o.forEach(c=>c.classList.add("disabled")),o.forEach((c,d)=>{d===t&&c.classList.add("correct"),c===s&&!p&&c.classList.add("wrong")}),C(p?"correct":"wrong"),(p?n:l)(a)})})}function de(e){let t=0,n=0;function l(){e.innerHTML=`
    ...
    `,e.querySelector("#go-back")?.addEventListener("click",()=>z.navigate("/"));return}function i(){if(n>=t.length){o();return}let s=t[n],r="",a="",p=[],c=0;if(s.type==="vocab"){let f=E.find(x=>x.id===s.id);f&&(r=`<div class="game-question">${f.en}</div><div class="game-question-sub">\u8FD9\u4E2A\u82F1\u6587\u672F\u8BED\u7684\u4E2D\u6587\u662F\u4EC0\u4E48\uFF1F</div>`,a=f.zh,p=[...E.filter(u=>u.id!==f.id).sort(()=>Math.random()-.5).slice(0,3).map(u=>u.zh),f.zh].sort(()=>Math.random()-.5),c=p.indexOf(f.zh))}else if(s.type==="command"){let f=H.find(x=>x.id===s.id);f&&(r=`<div class="game-question">${f.scenario}</div><div class="game-question-sub">\u9009\u62E9\u6B63\u786E\u7684\u547D\u4EE4</div>`,a=f.command,p=[f.command,...f.wrongChoices.slice(0,3)].sort(()=>Math.random()-.5),c=p.indexOf(f.command))}if(p.length===0){n++,i();return}e.innerHTML=`
      ${w(`\u590D\u4E60 ${n+1}/${t.length}`,!0)}
      <div class="game-screen">
    ...
    `;let d=()=>{let f=e.querySelector("#next-btn");f&&(f.style.display="block")};P(e,c,()=>{l++,y.markReviewCorrect(s.id),d()},()=>{d()}),e.querySelector("#next-btn")?.addEventListener("click",()=>{n++,i()})}function o(){let s=Math.round(l/t.length*100);e.innerHTML=`
      ${w("\u590D\u4E60\u5B8C\u6210",!1)}
      <div class="screen" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-lg);padding-top:calc(var(--header-height) + var(--space-xl));">
    ...
    `,e.querySelector("#go-home")?.addEventListener("click",()=>z.navigate("/")),C("levelUp")}i()}function ue(e,t){let n=t?"unlocked":"locked",l=t?e.idiom:"???",i=t?e.pinyin:"";return`
  ...
  `,!document.getElementById("hongbao-styles")){let o=document.createElement("style");o.id="hongbao-styles",o.textContent=`
    ...
    `,document.head.appendChild(o)}let t=e.querySelector(".hongbao-particles"),n=["#ffc107","#ff5252","#ff9800","#ffeb3b","#e53935"];for(let o=0;o<20;o++){let s=document.createElement("div");s.className="hongbao-particle",s.style.background=n[o%n.length],s.style.left="50%",s.style.top="50%",s.style.setProperty("--px",`${(Math.random()-.5)*300}px`),s.style.setProperty("--py",`${(Math.random()-.5)*300}px`),s.style.animationDelay=`${.3+Math.random()*.5}s`,t.appendChild(s)}document.body.appendChild(e);let l=()=>{clearTimeout(i),e.style.opacity="0",e.style.transition="opacity 0.3s",setTimeout(()=>e.remove(),300)};e.addEventListener("click",l);let i=setTimeout(l,3e3)}function $(e,t){let{worldId:n,levelIndex:l,score:i,total:o,gameType:s}=t,r=Math.round(i/Math.max(1,o)*100),a=r>=100?3:r>=70?2:r>=40?1:0,p=r>=100,c=r>=40;c&&y.completeLevel(n,l,r);let d=[];function f(g,b){if(b&&y.addBadge(g)){let h=j.find(m=>m.id===g);h&&d.push(h)}}f("first-step",y.getTotalLevelsCompleted()>=1),f("quick-learner",p&&l===0),f("command-king",y.getWorldCompletion(2)>=100),f("prompt-sage",p&&s==="prompt-builder"),f("interview-ready",s==="boss-battle"&&c),f("completionist",[1,2,3,4].every(g=>y.getWorldCompletion(g)>=100)),f("speed-demon",p),f("practice-master",y.getStreak().current>=7),f("unstoppable",y.getStreak().current>=21);let x=y.getWorldCompletion(n)>=100,u="correctAnswer";p?u="perfectScore":c?x&&(u="worldComplete"):u="retry",e.innerHTML=`
    ${w("\u7ED3\u679C Results",!1)}
    <div class="screen" style="display:flex;flex-direction:column;align-items:center;gap:var(--space-lg);padding-top:calc(var(--header-height) + var(--space-xl));">
      ${S(u)}
      <div style="text-align:center;">
      ...
      <div style="display:flex;flex-direction:column;gap:var(--space-sm);width:100%;">
        ${c?'<button class="btn btn-primary btn-block" id="next-level">\u4E0B\u4E00\u5173 Next Level \u2192</button>':""}
  ...
  `,d.forEach((g,b)=>{setTimeout(()=>ge(g),(b+1)*800)}),p?(setTimeout(()=>ve(),500),C("perfect")):c?C("levelUp"):C("wrong"),e.querySelector("#next-level")?.addEventListener("click",()=>{let g=l+1,b=y.getWorldLevelCount(n);g<b?z.navigate(`/world/${n}`):n<4?z.navigate(`/world/${n+1}`):z.navigate("/")}),e.querySelector("#retry")?.addEventListener("click",()=>{z.navigate(`/game/${s}/${n}/${l}`)}),e.querySelector("#go-home")?.addEventListener("click",()=>z.navigate("/"))}function fe(e,t,n){let i=E.filter(p=>p.world===t);i.length<10&&(i=[...E]);let o=T(i).slice(0,10),s=0,r=0;function a(){if(s>=o.length){$(e,{worldId:t,levelIndex:n,score:r,total:10,gameType:"flash-match"});return}let p=o[s],c=s+1;e.innerHTML=`
    ...
    `;let d=e.querySelector("#flashcard"),f=e.querySelector("#action-btns");d.addEventListener("click",()=>{d.classList.contains("flipped")||(d.classList.add("flipped"),C("cardFlip"),f.style.visibility="visible")}),e.querySelector("#btn-know")?.addEventListener("click",()=>{r++,C("correct"),s++,a()}),e.querySelector("#btn-review")?.addEventListener("click",()=>{y.addToReviewQueue({id:p.id,type:"vocab"}),C("wrong"),s++,a()})}a()}function Re(e,t){let n=E.filter(i=>i.world===e);return n.length<4&&(n=[...E]),T(n).slice(0,t).map(i=>{let o=T(E.filter(a=>a.id!==i.id)).slice(0,3),s=T([i,...o]),r=s.findIndex(a=>a.id===i.id);return{question_zh:`\u300C${i.zh}\u300D\u7684\u82F1\u6587\u662F\u4EC0\u4E48\uFF1F`,question_en:`What is "${i.zh}" in English?`,options:s.map(a=>a.en),correctIndex:r,explanation:i.explanation}})}function ye(e,t,n){let o=[];o=Re(t,10);let s=0,r=0,a=null;function p(){a&&(clearInterval(a),a=null)}function c(){if(p(),s>=o.length){$(e,{worldId:t,levelIndex:n,score:r,total:o.length,gameType:"trivia"});return}let d=o[s],f=s+1,x=["A","B","C","D"];e.innerHTML=`
      ${w("\u77E5\u8BC6\u95EE\u7B54 Trivia",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
    ...
    `;let u=15*10,g=e.querySelector("#timer-fill");a=setInterval(()=>{u--;let m=u/(15*10)*100;g.style.width=`${m}%`,m<=20?g.className="timer-bar-fill danger":m<=50&&(g.className="timer-bar-fill warning"),u<=0&&(p(),h())},100),z.setCleanup(()=>p());function b(m){p();let v=e.querySelector("#feedback");if(v.style.display="block",m)r++,v.innerHTML=M(!0,`<strong>\u6B63\u786E\uFF01 Correct!</strong><br>${d.explanation}`);else{let _=E.find(k=>k.en===d.options[d.correctIndex]);_&&y.addToReviewQueue({id:_.id,type:"vocab"}),v.innerHTML=M(!1,`<strong>\u6B63\u786E\u7B54\u6848: ${d.options[d.correctIndex]}</strong><br>${d.explanation}`)}setTimeout(()=>{s++,c()},2500)}function h(){p();let m=e.querySelectorAll(".option-btn");m.forEach(k=>k.classList.add("disabled")),m.forEach((k,L)=>{L===d.correctIndex&&k.classList.add("correct")}),C("wrong");let v=e.querySelector("#feedback");v.style.display="block",v.innerHTML=M(!1,`<strong>\u65F6\u95F4\u5230\uFF01 Time's up! \u6B63\u786E\u7B54\u6848: ${d.options[d.correctIndex]}</strong><br>${d.explanation}`);let _=E.find(k=>k.en===d.options[d.correctIndex]);_&&y.addToReviewQueue({id:_.id,type:"vocab"}),setTimeout(()=>{s++,c()},2500)}P(e,d.correctIndex,()=>b(!0),()=>b(!1))}c()}U();function be(e){return`
  ...
  `}function xe(e){let t=e.querySelector("[data-terminal]");if(!t)return;let n=t.querySelector("[data-terminal-output]"),l=t.querySelector("[data-terminal-input]");if(!n||!l)return;let i={};Promise.resolve().then(()=>(U(),pe)).then(r=>{r.commands&&Array.isArray(r.commands)?r.commands.forEach(a=>{i[a.command.toLowerCase()]={terminalResponse:a.terminalResponse}}):r.commands&&typeof r.commands=="object"&&(i=r.commands)}).catch(()=>{});function o(r,a){if(!n)return;let p=document.createElement("div");p.className=a?"terminal-line terminal-command":"terminal-line terminal-response",a?p.textContent=`$ ${r}`:p.innerHTML=r,n.appendChild(p),n.scrollTop=n.scrollHeight}function s(r){let a=r.trim().toLowerCase();if(o(r,!0),a==="")return;let p=Object.keys(i).find(c=>a===c.toLowerCase()||a.startsWith(c.toLowerCase()));if(p)o(i[p].terminalResponse);else if(a==="/help"||a==="help"){let c=Object.keys(i).map(d=>`  ${d}`).join("<br>");o(`\u53EF\u7528\u547D\u4EE4 / Available commands:<br>${c||"  (loading...)"}`)}else o("\u7801\u5C0F\u7801\u8BF4\uFF1A\u8FD9\u4E2A\u547D\u4EE4\u6211\u8FD8\u4E0D\u8BA4\u8BC6\u54E6\uFF01\u8BD5\u8BD5 /help\uFF1F")}l.addEventListener("keydown",r=>{if(r.key==="Enter"){let a=l.value;l.value="",s(a)}}),t.addEventListener("click",()=>{l.focus()})}function Ce(e,t,n){let i=T([...H]).slice(0,8),o=0,s=0;function r(){if(o>=i.length){$(e,{worldId:t,levelIndex:n,score:s,total:8,gameType:"charades"});return}let a=i[o],p=o+1,c=T([a.command+" \u2014 "+a.zhName,...a.wrongChoices]),d=a.command+" \u2014 "+a.zhName,f=c.indexOf(d),x=["A","B","C","D"];e.innerHTML=`
      ${w("\u573A\u666F\u731C\u8C1C Charades",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>${p}/8</span>
    ...
    `;let u=e.querySelector("#feedback-area");function g(b){u.style.display="block",b?(s++,u.innerHTML=`
          ${M(!0,`<strong>\u6B63\u786E\uFF01 Correct!</strong><br>${a.zhDescription}`)}
        ...
        <div class="game-screen">
          ...
          <div class="game-body">
            <div class="workflow-slots" id="slots">
              ${d.map((u,g)=>`
                <div class="workflow-slot">
                  ...
                  <div class="drop-zone ${u?"filled":""}" data-slot="${g}">
                    ${u||""}
                  </div>
                </div>
              `).join("")}
            ...
            <div class="block-tray" id="tray">
              ${x.map(u=>`
                <div class="prompt-block" data-step="${u}">${u}</div>
              `).join("")}
            </div>
          </div>
      ...
      `,e.querySelectorAll(".prompt-block").forEach(u=>{u.addEventListener("click",()=>{let g=u.dataset.step||"",b=d.indexOf(null);b!==-1&&(d[b]=g,C("keystroke"),f())})}),e.querySelectorAll(".drop-zone.filled").forEach(u=>{u.addEventListener("click",()=>{let g=parseInt(u.dataset.slot||"-1");g>=0&&d[g]&&(d[g]=null,C("keystroke"),f())})}),e.querySelector("#btn-reset")?.addEventListener("click",()=>{d.fill(null),f()}),e.querySelector("#btn-submit")?.addEventListener("click",()=>{let u=d.every((h,m)=>h===a.steps[m]),g=e.querySelector("#feedback");g.style.display="block",u?(s++,C("correct"),g.innerHTML=M(!0,"<strong>\u6B63\u786E\uFF01 Correct!</strong><br>\u5B8C\u7F8E\u7684\u6D41\u7A0B\u987A\u5E8F\uFF01")):(C("wrong"),g.innerHTML=M(!1,`<strong>\u6B63\u786E\u987A\u5E8F Correct order:</strong><br>${a.steps.map((h,m)=>`${m+1}. ${h}`).join("<br>")}`));let b=e.querySelector("#footer");b.innerHTML='<button class="btn btn-primary btn-block" id="next-btn">\u4E0B\u4E00\u9898 Next \u2192</button>',e.querySelector("#next-btn")?.addEventListener("click",()=>{o++,r()})})}}r()}U();function _e(e,t,n){let i=T([...H]).slice(0,8),o=T([...i.map(x=>({id:x.id+"-en",pairId:x.id,text:x.command,type:"en"})),...i.map(x=>({id:x.id+"-zh",pairId:x.id,text:x.zhName,type:"zh"}))]),s=[],r=[],a=0,p=Date.now(),c=!1;function d(){let x=Math.floor((Date.now()-p)/1e3),u=Math.floor(x/60),g=x%60;e.innerHTML=`
      ${w("\u8BB0\u5FC6\u914D\u5BF9 Memory Match",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>\u6B65\u6570 Moves: ${a}</span>
          <span>\u914D\u5BF9 Pairs: ${r.length}/8</span>
          <span id="timer">${u}:${g.toString().padStart(2,"0")}</span>
        </div>
        <div class="progress-bar">
        ...
        <div class="game-body" style="justify-content:center;">
          <div class="memory-grid">
            ${o.map((b,h)=>{let m=s.includes(h),v=r.includes(b.pairId),_=["memory-card"];return(m||v)&&_.push("flipped"),v&&_.push("matched"),`
    ...
    `,e.querySelectorAll(".memory-card").forEach(b=>{b.addEventListener("click",()=>{if(c)return;let h=parseInt(b.dataset.index||"-1");if(!(h<0||s.includes(h)||r.includes(o[h].pairId))&&(s.push(h),b.classList.add("flipped"),C("cardFlip"),s.length===2)){a++,c=!0;let[m,v]=s,_=o[m],k=o[v];if(_.pairId===k.pairId&&_.type!==k.type){if(r.push(_.pairId),C("correct"),s=[],c=!1,e.querySelectorAll(`.memory-card[data-index="${m}"], .memory-card[data-index="${v}"]`).forEach(L=>L.classList.add("matched")),r.length===8){let L=Math.floor((Date.now()-p)/1e3),R=Math.max(20,100-(a-8)*5);setTimeout(()=>{$(e,{worldId:t,levelIndex:n,score:R,total:100,gameType:"memory-match"})},800)}}else setTimeout(()=>{s=[],c=!1,d()},800)}})})}let f=setInterval(()=>{let x=e.querySelector("#timer");if(!x){clearInterval(f);return}let u=Math.floor((Date.now()-p)/1e3),g=Math.floor(u/60),b=u%60;x.textContent=`${g}:${b.toString().padStart(2,"0")}`},1e3);z.setCleanup(()=>clearInterval(f)),d()}var W=[{id:"pe1",task_zh:"\u7ED9\u9879\u76EE\u6DFB\u52A0\u7528\u6237\u767B\u5F55\u529F\u80FD",badPrompt:"\u5E2E\u6211\u52A0\u4E2A\u767B\u5F55",goodPrompt:"\u5728 src/auth.ts \u4E2D\u6DFB\u52A0\u4E00\u4E2A login \u51FD\u6570\uFF0C\u63A5\u6536 email \u548C password \u53C2\u6570\uFF0C\u4F7F\u7528 bcrypt \u9A8C\u8BC1\u5BC6\u7801\uFF0C\u8FD4\u56DE JWT token\u3002\u53C2\u8003\u9879\u76EE\u4E2D\u5DF2\u6709\u7684 register \u51FD\u6570\u7684\u98CE\u683C\u3002",rating:{clarity:5,specificity:5,context:4,tone:5},explanation_zh:"\u597D\u7684\u63D0\u793A\u8BCD\u6307\u5B9A\u4E86\u6587\u4EF6\u4F4D\u7F6E\u3001\u51FD\u6570\u540D\u3001\u53C2\u6570\u3001\u6280\u672F\u5B9E\u73B0\u65B9\u6848\uFF0C\u8FD8\u63D0\u5230\u4E86\u53C2\u8003\u5DF2\u6709\u4EE3\u7801\u7684\u98CE\u683C\u3002Claude Code \u80FD\u7CBE\u786E\u6267\u884C\u3002"},{id:"pe2",task_zh:"\u4FEE\u590D\u4E00\u4E2A\u62A5\u9519",badPrompt:"\u4EE3\u7801\u6709 bug \u5E2E\u6211\u4FEE",goodPrompt:"\u8FD0\u884C npm test \u65F6\u62A5\u9519 TypeError: Cannot read property 'name' of undefined\uFF0C\u51FA\u73B0\u5728 src/utils.ts \u7B2C 42 \u884C\u3002\u8BF7\u5206\u6790\u539F\u56E0\u5E76\u4FEE\u590D\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u628A\u5B8C\u6574\u7684\u62A5\u9519\u4FE1\u606F\u3001\u6587\u4EF6\u4F4D\u7F6E\u548C\u884C\u53F7\u90FD\u7ED9\u4E86 Claude Code\uFF0C\u5B83\u4E0D\u9700\u8981\u731C\u6D4B\u5C31\u80FD\u76F4\u63A5\u5B9A\u4F4D\u95EE\u9898\u3002"},{id:"pe3",task_zh:"\u91CD\u6784\u4E00\u4E2A\u590D\u6742\u51FD\u6570",badPrompt:"\u8FD9\u4E2A\u51FD\u6570\u592A\u4E71\u4E86\uFF0C\u6539\u4E00\u4E0B",goodPrompt:"\u91CD\u6784 src/parser.ts \u4E2D\u7684 parseConfig \u51FD\u6570\u3002\u5F53\u524D\u51FD\u6570\u6709 120 \u884C\uFF0C\u8BF7\u62C6\u5206\u6210\u66F4\u5C0F\u7684\u8F85\u52A9\u51FD\u6570\uFF0C\u6BCF\u4E2A\u4E0D\u8D85\u8FC7 30 \u884C\u3002\u4FDD\u6301\u6240\u6709\u73B0\u6709\u6D4B\u8BD5\u901A\u8FC7\u3002",rating:{clarity:5,specificity:4,context:4,tone:5},explanation_zh:"\u660E\u786E\u4E86\u91CD\u6784\u76EE\u6807\uFF08\u62C6\u5206\u51FD\u6570\uFF09\u3001\u5177\u4F53\u6807\u51C6\uFF08\u6BCF\u4E2A\u4E0D\u8D85\u8FC7 30 \u884C\uFF09\u548C\u7EA6\u675F\u6761\u4EF6\uFF08\u6D4B\u8BD5\u8981\u901A\u8FC7\uFF09\uFF0CClaude Code \u6709\u6E05\u6670\u7684\u65B9\u5411\u3002"},{id:"pe4",task_zh:"\u4E3A\u51FD\u6570\u6DFB\u52A0 TypeScript \u7C7B\u578B",badPrompt:"\u52A0\u7C7B\u578B",goodPrompt:"\u7ED9 src/api.ts \u4E2D\u6240\u6709\u5BFC\u51FA\u51FD\u6570\u6DFB\u52A0 TypeScript \u7C7B\u578B\u58F0\u660E\u3002\u53C2\u6570\u548C\u8FD4\u56DE\u503C\u90FD\u8981\u6709\u660E\u786E\u7C7B\u578B\uFF0C\u4E0D\u8981\u7528 any\u3002\u53C2\u8003\u9879\u76EE\u7684 tsconfig.json \u4E2D\u7684 strict \u914D\u7F6E\u3002",rating:{clarity:4,specificity:4,context:4,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u8303\u56F4\uFF08\u6240\u6709\u5BFC\u51FA\u51FD\u6570\uFF09\u3001\u8981\u6C42\uFF08\u4E0D\u7528 any\uFF09\u548C\u53C2\u8003\u6587\u4EF6\uFF08tsconfig.json\uFF09\uFF0CClaude Code \u80FD\u6309\u89C4\u8303\u6267\u884C\u3002"},{id:"pe5",task_zh:"\u521B\u5EFA\u4E00\u4E2A\u65B0\u7684 API \u7AEF\u70B9",badPrompt:"\u5199\u4E2A API",goodPrompt:"\u5728 src/routes/users.ts \u4E2D\u65B0\u589E\u4E00\u4E2A GET /api/users/:id \u7AEF\u70B9\u3002\u8FD4\u56DE\u7528\u6237\u4FE1\u606F\uFF08name, email, createdAt\uFF09\uFF0C\u5982\u679C\u7528\u6237\u4E0D\u5B58\u5728\u8FD4\u56DE 404\u3002\u4F7F\u7528\u9879\u76EE\u4E2D\u5DF2\u6709\u7684 db.query \u65B9\u6CD5\u67E5\u8BE2\u6570\u636E\u5E93\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u5B8C\u7F8E\u7684\u63D0\u793A\u8BCD\uFF1A\u6307\u5B9A\u4E86\u6587\u4EF6\u3001\u8DEF\u5F84\u3001HTTP \u65B9\u6CD5\u3001\u8FD4\u56DE\u5B57\u6BB5\u3001\u9519\u8BEF\u5904\u7406\u548C\u6570\u636E\u5E93\u65B9\u6CD5\u3002Claude Code \u51E0\u4E4E\u4E0D\u9700\u8981\u989D\u5916\u95EE\u4F60\u3002"},{id:"pe6",task_zh:"\u4F18\u5316\u9875\u9762\u52A0\u8F7D\u901F\u5EA6",badPrompt:"\u7F51\u7AD9\u592A\u6162\u4E86",goodPrompt:"\u9996\u9875\u52A0\u8F7D\u9700\u8981 5 \u79D2\uFF0C\u4E3B\u8981\u74F6\u9888\u662F src/components/Dashboard.tsx \u4E2D\u4E00\u6B21\u6027\u52A0\u8F7D\u4E86\u6240\u6709\u6570\u636E\u3002\u8BF7\u6539\u4E3A\u61D2\u52A0\u8F7D\uFF1A\u5148\u52A0\u8F7D\u9996\u5C4F\u6570\u636E\uFF0C\u6EDA\u52A8\u65F6\u518D\u52A0\u8F7D\u66F4\u591A\u3002\u4F7F\u7528 Intersection Observer API\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u63D0\u4F9B\u4E86\u6027\u80FD\u6307\u6807\uFF085 \u79D2\uFF09\u3001\u95EE\u9898\u5B9A\u4F4D\uFF08Dashboard.tsx\uFF09\u3001\u89E3\u51B3\u65B9\u6848\uFF08\u61D2\u52A0\u8F7D\uFF09\u548C\u6280\u672F\u5B9E\u73B0\uFF08Intersection Observer\uFF09\uFF0C\u975E\u5E38\u6E05\u6670\u3002"},{id:"pe7",task_zh:"\u5199\u5355\u5143\u6D4B\u8BD5",badPrompt:"\u5199\u6D4B\u8BD5",goodPrompt:"\u4E3A src/utils/formatDate.ts \u4E2D\u7684 formatDate \u51FD\u6570\u5199\u5355\u5143\u6D4B\u8BD5\u3002\u8986\u76D6\u4EE5\u4E0B\u573A\u666F\uFF1A\u6709\u6548\u65E5\u671F\u3001\u65E0\u6548\u8F93\u5165\uFF08null, undefined, \u7A7A\u5B57\u7B26\u4E32\uFF09\u3001\u4E0D\u540C\u65F6\u533A\u3002\u4F7F\u7528\u9879\u76EE\u5DF2\u6709\u7684 vitest \u6846\u67B6\u3002",rating:{clarity:5,specificity:5,context:4,tone:5},explanation_zh:"\u5217\u51FA\u4E86\u5177\u4F53\u7684\u6D4B\u8BD5\u573A\u666F\u548C\u8FB9\u754C\u6761\u4EF6\uFF0C\u6307\u5B9A\u4E86\u6D4B\u8BD5\u6846\u67B6\u3002Claude Code \u80FD\u5199\u51FA\u5168\u9762\u7684\u6D4B\u8BD5\u7528\u4F8B\u3002"},{id:"pe8",task_zh:"\u6DFB\u52A0\u6697\u8272\u4E3B\u9898\u652F\u6301",badPrompt:"\u52A0\u4E2A\u6697\u8272\u6A21\u5F0F",goodPrompt:"\u4E3A\u5E94\u7528\u6DFB\u52A0\u6697\u8272\u4E3B\u9898\u5207\u6362\u3002\u5728 src/styles/globals.css \u4E2D\u7528 CSS \u53D8\u91CF\u5B9A\u4E49\u989C\u8272\uFF0C\u5728 src/components/Header.tsx \u6DFB\u52A0\u5207\u6362\u6309\u94AE\uFF0C\u7528 localStorage \u8BB0\u4F4F\u7528\u6237\u504F\u597D\u3002\u5F53\u524D\u6D45\u8272\u4E3B\u9898\u8272\u53F7\uFF1A\u80CC\u666F #FFFFFF\uFF0C\u6587\u5B57 #1A1A1A\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u5B9E\u73B0\u65B9\u6848\uFF08CSS \u53D8\u91CF\uFF09\u3001\u4FEE\u6539\u6587\u4EF6\u3001\u6301\u4E45\u5316\u65B9\u5F0F\uFF08localStorage\uFF09\u548C\u73B0\u6709\u914D\u8272\uFF0CClaude Code \u6709\u5B8C\u6574\u4FE1\u606F\u6765\u5B9E\u73B0\u3002"},{id:"pe9",task_zh:"\u4EE3\u7801\u5BA1\u67E5",badPrompt:"\u770B\u770B\u6709\u6CA1\u6709\u95EE\u9898",goodPrompt:"\u5BA1\u67E5 src/services/payment.ts \u4E2D\u7684 processPayment \u51FD\u6570\u3002\u91CD\u70B9\u68C0\u67E5\uFF1A1) \u9519\u8BEF\u5904\u7406\u662F\u5426\u5B8C\u5584 2) \u662F\u5426\u6709\u5B89\u5168\u6F0F\u6D1E 3) \u662F\u5426\u6B63\u786E\u5904\u7406\u4E86\u5E76\u53D1\u8BF7\u6C42\u3002",rating:{clarity:5,specificity:4,context:3,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u5BA1\u67E5\u6587\u4EF6\u548C\u4E09\u4E2A\u91CD\u70B9\u5173\u6CE8\u65B9\u5411\uFF0CClaude Code \u53EF\u4EE5\u6709\u9488\u5BF9\u6027\u5730\u8FDB\u884C\u4EE3\u7801\u5BA1\u67E5\u3002"},{id:"pe10",task_zh:"\u914D\u7F6E CI/CD \u6D41\u6C34\u7EBF",badPrompt:"\u5E2E\u6211\u81EA\u52A8\u5316\u90E8\u7F72",goodPrompt:"\u521B\u5EFA .github/workflows/deploy.yml \u914D\u7F6E GitHub Actions\uFF1Apush \u5230 main \u5206\u652F\u65F6\u81EA\u52A8\u8FD0\u884C npm test\uFF0C\u6D4B\u8BD5\u901A\u8FC7\u540E\u7528 wrangler \u90E8\u7F72\u5230 Cloudflare Pages\u3002\u9879\u76EE\u540D\u662F my-app\u3002",rating:{clarity:5,specificity:5,context:5,tone:5},explanation_zh:"\u5305\u542B\u4E86\u6587\u4EF6\u8DEF\u5F84\u3001\u89E6\u53D1\u6761\u4EF6\u3001\u6B65\u9AA4\uFF08\u6D4B\u8BD5\u2192\u90E8\u7F72\uFF09\u3001\u5DE5\u5177\uFF08wrangler\uFF09\u548C\u9879\u76EE\u540D\uFF0CClaude Code \u80FD\u751F\u6210\u5B8C\u6574\u7684 CI/CD \u914D\u7F6E\u3002"},{id:"pe11",task_zh:"\u89E3\u91CA\u4E00\u6BB5\u4EE3\u7801",badPrompt:"\u8FD9\u662F\u4EC0\u4E48",goodPrompt:"\u8BF7\u9010\u884C\u89E3\u91CA src/middleware/auth.ts \u4E2D\u7684 verifyToken \u4E2D\u95F4\u4EF6\u51FD\u6570\u3002\u6211\u662F\u65B0\u624B\uFF0C\u8BF7\u7528\u7B80\u5355\u7684\u8BED\u8A00\uFF0C\u5E76\u89E3\u91CA\u4E3A\u4EC0\u4E48\u6BCF\u4E00\u6B65\u662F\u5FC5\u8981\u7684\u3002",rating:{clarity:5,specificity:4,context:4,tone:5},explanation_zh:"\u8BF4\u660E\u4E86\u8981\u89E3\u91CA\u7684\u5177\u4F53\u51FD\u6570\u3001\u89E3\u91CA\u65B9\u5F0F\uFF08\u9010\u884C\uFF09\u3001\u4F60\u7684\u6C34\u5E73\uFF08\u65B0\u624B\uFF09\u548C\u671F\u671B\uFF08\u7B80\u5355\u8BED\u8A00\uFF09\uFF0CClaude Code \u80FD\u7ED9\u51FA\u5408\u9002\u7684\u89E3\u91CA\u3002"},{id:"pe12",task_zh:"\u8FC1\u79FB\u6570\u636E\u5E93",badPrompt:"\u6362\u4E2A\u6570\u636E\u5E93",goodPrompt:"\u628A\u9879\u76EE\u4ECE SQLite \u8FC1\u79FB\u5230 PostgreSQL\u3002\u9700\u8981\u4FEE\u6539\u7684\u6587\u4EF6\uFF1Asrc/db/connection.ts\uFF08\u8FDE\u63A5\u914D\u7F6E\uFF09\u3001src/db/queries.ts\uFF08SQL \u8BED\u6CD5\u5DEE\u5F02\uFF09\u3002\u4FDD\u6301\u6240\u6709\u73B0\u6709\u7684 API \u63A5\u53E3\u4E0D\u53D8\u3002",rating:{clarity:5,specificity:5,context:4,tone:5},explanation_zh:"\u6307\u5B9A\u4E86\u8FC1\u79FB\u65B9\u5411\u3001\u9700\u8981\u4FEE\u6539\u7684\u6587\u4EF6\u53CA\u539F\u56E0\u3001\u7EA6\u675F\u6761\u4EF6\uFF08API \u4E0D\u53D8\uFF09\u3002Claude Code \u53EF\u4EE5\u7CFB\u7EDF\u6027\u5730\u5B8C\u6210\u8FC1\u79FB\u3002"}];function ke(e,t,n){let i=T(W).slice(0,5),o=0,s=0;function r(){let a=i[o],p=a.goodPrompt.split(/\s+/),c=T(p),d=[];e.innerHTML=`
      ...
      <div class="game-screen">
        ...
        <div class="game-body">
          ...
          <div class="block-tray" id="tray">
            ${c.map((h,m)=>`<div class="prompt-block" data-index="${m}" data-word="${h}">${h}</div>`).join("")}
          </div>
        </div>
        <div class="game-footer">
    ...
    `;let f=e.querySelector("#tray"),x=e.querySelector("#assembly"),u=e.querySelector("#submit-btn"),g=e.querySelector("#assembly-placeholder");function b(){g&&(g.style.display=d.length>0?"none":""),u.disabled=d.length===0}f.addEventListener("click",h=>{let m=h.target.closest(".prompt-block");if(!m||m.classList.contains("placed"))return;C("keystroke"),m.classList.add("placed");let v=m.dataset.word;d.push(v);let _=document.createElement("div");_.className="prompt-block",_.textContent=v,_.dataset.trayIndex=m.dataset.index,x.appendChild(_),_.addEventListener("click",()=>{C("keystroke");let k=d.indexOf(v);k!==-1&&d.splice(k,1),_.remove(),m.classList.remove("placed"),b()}),b()}),u.addEventListener("click",()=>{let h=p,m=0,v=h.length;for(let q=0;q<Math.min(d.length,v);q++)d[q]===h[q]&&m++;let k=m/v>=.8;k?(s++,C("correct")):(C("wrong"),y.addToReviewQueue({id:a.id,type:"prompt"}));let L=a.rating,R=[["\u6E05\u6670\u5EA6 Clarity",L.clarity],["\u5177\u4F53\u6027 Specificity",L.specificity],["\u4E0A\u4E0B\u6587 Context",L.context],["\u8BED\u6C14 Tone",L.tone]];e.innerHTML=`
        ${w("\u63D0\u793A\u8BCD\u62FC\u88C5 Prompt Builder",!0)}
        <div class="game-screen">
          <div class="game-score-bar">
            <span>\u7B2C ${o+1}/5 \u9898</span>
          ...
          <div class="game-question" style="font-size:var(--text-base);">
            ${k?'<span style="color:var(--green);">\u6B63\u786E!</span>':'<span style="color:var(--red);">\u518D\u52A0\u6CB9!</span>'}
          </div>
      ...
      `,e.querySelector("#next-btn").addEventListener("click",()=>{o++,o<5?r():$(e,{worldId:t,levelIndex:n,score:s,total:5,gameType:"prompt-builder"})})})}r()}function ze(e,t,n){let i=T(W).slice(0,5),o=0,s=0;function r(){let a=i[o],p=a.badPrompt.split(/\s+/),c=a.goodPrompt.split(/\s+/),d=new Set(p.map(m=>m.toLowerCase())),f=c.filter(m=>!d.has(m.toLowerCase())),x=T(f),u=p.map(m=>({word:m,removed:!1})),g=[];e.innerHTML=`
      ...
      <div class="game-screen">
        ...
        <div class="game-body">
          ...
          <div class="editable-prompt" id="editable">
            ${p.map((m,v)=>`<span class="word-token" data-index="${v}">${m}</span>`).join("")}
          </div>
          ...
          <div class="word-bank" id="bank">
            ${x.map((m,v)=>`<span class="word-token" data-bank="${v}" data-word="${m}">${m}</span>`).join("")}
          </div>
        </div>
        <div class="game-footer">
    ...
    `;let b=e.querySelector("#editable"),h=e.querySelector("#bank");b.addEventListener("click",m=>{let v=m.target.closest(".word-token");if(!v)return;let _=v.dataset.index,k=v.dataset.bank;if(_!==void 0){let L=parseInt(_);u[L].removed=!u[L].removed,v.classList.toggle("removed",u[L].removed),C("keystroke")}else if(k!==void 0){C("keystroke");let L=v.dataset.word,R=g.findIndex(D=>D.word===L);R!==-1&&g.splice(R,1),v.remove();let q=h.querySelector(`[data-bank="${k}"]`);q&&(q.classList.remove("selected"),q.style.display="")}}),h.addEventListener("click",m=>{let v=m.target.closest(".word-token");if(!v||v.classList.contains("selected"))return;C("keystroke");let _=v.dataset.word,k=v.dataset.bank;v.classList.add("selected"),v.style.display="none",g.push({word:_,afterIndex:u.length});let L=document.createElement("span");L.className="word-token selected",L.textContent=_,L.dataset.bank=k,L.dataset.word=_,b.appendChild(L)}),e.querySelector("#submit-btn").addEventListener("click",()=>{let m=[];u.forEach(I=>{I.removed||m.push(I.word)}),g.forEach(I=>m.push(I.word));let v=m.join(" ").toLowerCase(),_=new Set(c.map(I=>I.toLowerCase())),k=new Set(m.map(I=>I.toLowerCase())),L=0;_.forEach(I=>{k.has(I)&&L++});let R=p.filter(I=>!_.has(I.toLowerCase())),q=0;R.forEach(I=>{k.has(I.toLowerCase())&&q++});let ee=Math.max(0,L/_.size-q*.1)>=.5;ee?(s++,C("correct")):(C("wrong"),y.addToReviewQueue({id:a.id,type:"prompt"})),e.innerHTML=`
        ${w("\u63D0\u793A\u8BCD\u4FEE\u590D Prompt Repair",!0)}
        <div class="game-screen">
          <div class="game-score-bar">
            <span>\u7B2C ${o+1}/5 \u9898</span>
      ...
      <div class="game-screen">
        ...
        <div class="game-question" style="font-size:var(--text-base);">${c.task_zh}</div>
    ...
    `;let g=e.querySelector("#card-left"),b=e.querySelector("#card-right"),h=e.querySelector("#explanation"),m=e.querySelector("#explanation-text"),v=e.querySelector("#next-btn"),_=!1;function k(L){if(_)return;_=!0,L===u?(a++,C("correct")):(C("wrong"),y.addToReviewQueue({id:c.id,type:"prompt"}));let q=u==="left"?g:b,D=u==="left"?b:g;q.classList.add("correct"),D.classList.add("wrong"),g.style.pointerEvents="none",b.style.pointerEvents="none",m.textContent=c.explanation_zh,h.style.display="",v.style.display=""}g.addEventListener("click",()=>k("left")),b.addEventListener("click",()=>k("right")),v.addEventListener("click",()=>{r++,r<10?p():$(e,{worldId:t,levelIndex:n,score:a,total:10,gameType:"prompt-duel"})})}p()}var De=[{question_zh:"\u4F60\u4F1A\u600E\u6837\u5F00\u59CB\u4E00\u4E2A\u65B0\u9879\u76EE\uFF1F",question_en:"How would you start a new project?",correctCommand:"/init",commandOptions:["/init","/setup","/new","/config"],keywords:["scaffold","CLAUDE.md","initialize"]},{question_zh:"\u4EE3\u7801\u5E93\u592A\u5927\uFF0C\u653E\u4E0D\u8FDB\u4E0A\u4E0B\u6587\u7A97\u53E3\u3002\u4F60\u4F1A\u600E\u4E48\u505A\uFF1F",question_en:"The codebase is too large for context. What do you do?",correctCommand:"/compact",commandOptions:["/compact","/clear","/shrink","/trim"],keywords:["context","compact","window"]},{question_zh:"\u4F60\u9700\u8981\u64A4\u9500\u4E00\u4E2A\u6700\u8FD1\u7684\u6539\u52A8\u3002\u600E\u4E48\u529E\uFF1F",question_en:"You need to undo a recent change. How?",correctCommand:"/rewind",commandOptions:["/rewind","/undo","/rollback","/restore"],keywords:["revert","undo","checkpoint"]},{question_zh:"\u4F60\u60F3\u67E5\u770B API \u7528\u91CF\u3002\u600E\u4E48\u64CD\u4F5C\uFF1F",question_en:"How do you check your API usage?",correctCommand:"/usage",commandOptions:["/usage","/cost","/billing","/stats"],keywords:["token","cost","usage"]},{question_zh:"\u4EE3\u7801\u5BA1\u67E5\u6D41\u7A0B\u662F\u600E\u6837\u7684\uFF1F",question_en:"Code review process?",correctCommand:"/review",commandOptions:["/review","/lint","/check","/audit"],keywords:["review","quality","feedback"]},{question_zh:"\u5982\u4F55\u7B80\u5316\u590D\u6742\u7684\u4EE3\u7801\uFF1F",question_en:"How to simplify complex code?",correctCommand:"/simplify",commandOptions:["/simplify","/explain","/easy","/translate"],keywords:["refactor","simplify","clean"]}];function Le(e,t,n){let o=T(De).slice(0,3),s=0,r=0,a=!0;function p(){e.innerHTML=`
    ...
    `,e.querySelector("#start-btn")?.addEventListener("click",()=>{a=!1,c()})}function c(){if(s>=o.length){$(e,{worldId:t,levelIndex:n,score:r,total:3*100,gameType:"boss-battle"});return}let d=o[s],f=s+1,x=T(d.commandOptions);e.innerHTML=`
      ${w("\u9762\u8BD5\u6A21\u62DF Boss Battle",!0)}
      <div class="game-screen">
        <div class="game-score-bar">
          <span>\u573A\u666F ${f}/3</span>
      ...
      <div class="game-screen">
        ...
        <div class="game-body">
          <div class="card" style="line-height:1.8;">
            <p style="font-size:var(--text-base);margin-bottom:var(--space-sm);">${c.instruction_zh}</p>
            <p style="font-size:var(--text-sm);color:var(--text-secondary);">${c.instruction_en}</p>
          </div>
          ${f?`
    ...
    `,f){let x=!1,u=e.querySelectorAll("#quiz-options .option-btn");u.forEach(g=>{g.addEventListener("click",()=>{if(x)return;x=!0,s++;let h=parseInt(g.dataset.index||"-1")===c.correctIndex;u.forEach(v=>v.classList.add("disabled")),h?(r++,g.classList.add("correct"),C("correct")):(g.classList.add("wrong"),u.forEach((v,_)=>{_===c.correctIndex&&v.classList.add("correct")}),C("wrong"));let m=e.querySelector("#step-feedback");m.style.display="block",m.style.background=h?"rgba(0, 212, 170, 0.1)":"rgba(255, 107, 107, 0.1)",m.style.border=h?"1px solid var(--green)":"1px solid var(--red)",m.innerHTML=h?"<strong>\u6B63\u786E\uFF01 Correct!</strong>":`<strong>\u9519\u8BEF\u3002\u6B63\u786E\u7B54\u6848: ${(c.options||[])[c.correctIndex||0]}</strong>`,setTimeout(()=>{o++,p()},1800)})})}else e.querySelector("#next-step")?.addEventListener("click",()=>{o++,p()})}e.innerHTML=`
    ${w("\u6BCF\u65E5\u4EFB\u52A1 Daily Mission",!0)}
    <div class="game-screen">
      <div class="game-body" style="align-items:center;justify-content:center;flex:1;">
        ${S("dailyMission")}
  ...
  `,e.querySelector("#start-mission")?.addEventListener("click",()=>{p()})}function X(){let e=[];for(let t of[1,2,3,4])Z[t]&&e.push(...Z[t]);return e}function He(e,t){return btoa(JSON.stringify({q:e,s:t}))}function Oe(e){try{let t=e.startsWith("#peer=")?e.slice(6):null;if(!t)return null;let n=JSON.parse(atob(t));return{questionIds:n.q||[],peerScore:n.s||0}}catch{return null}}function Se(e,t,n){let i=Oe(window.location.hash),o;if(i&&i.questionIds.length>0){let c=X();o=i.questionIds.map(d=>c.find(f=>f.id===d)).filter(d=>!!d),o.length===0&&(o=T(X()).slice(0,5))}else o=T(X()).slice(0,5);let s=0,r=0;function a(){if(s>=o.length){p();return}let c=o[s],d=s+1,f=["A","B","C","D"];e.innerHTML=`
    ...
    `;let x=u=>{let g=e.querySelector("#feedback");g.style.display="block",g.innerHTML=u?M(!0,`<strong>\u6B63\u786E\uFF01 Correct!</strong><br>${c.explanation_zh}`):M(!1,`<strong>\u6B63\u786E\u7B54\u6848: ${c.options[c.correctIndex]}</strong><br>${c.explanation_zh}`),setTimeout(()=>{s++,a()},2e3)};P(e,c.correctIndex,()=>{r++,x(!0)},()=>{x(!1)})}function p(){let c=o.map(b=>b.id),d=He(c,r),x=`${window.location.origin+window.location.pathname}#peer=${d}`,u=Math.round(r/o.length*100);y.addBadge("sharing-caring");let g="";if(i){let b=Math.round(i.peerScore/o.length*100),h=u-b,m="";h>0?m=`\u4F60\u8D62\u4E86\uFF01 You won by ${h}%!`:h<0?m=`\u670B\u53CB\u8D62\u4E86\uFF01 Your friend won by ${Math.abs(h)}%!`:m="\u5E73\u5C40\uFF01 It's a tie!",g=`
        <div class="card" style="margin-top:var(--space-md);text-align:center;">
          ...
          <div style="display:flex;justify-content:center;gap:var(--space-xl);margin-bottom:var(--space-sm);">
            <div>
              <div style="font-size:var(--text-2xl);font-weight:700;color:var(--teal);">${u}%</div>
      ...
      <div class="game-screen">
        <div class="game-body" style="align-items:center;">
          ...
          <div style="text-align:center;margin-top:var(--space-md);">
            ...
            <div style="font-size:var(--text-lg);color:var(--text-secondary);margin-top:var(--space-xs);">${u}% \u6B63\u786E\u7387</div>
          </div>
          ${g}
  ...
  `,e.querySelector("#start-challenge")?.addEventListener("click",()=>{a()})}var O=document.getElementById("app"),We={"flash-match":fe,trivia:ye,charades:Ce,"drag-drop":we,"memory-match":_e,"prompt-builder":ke,"prompt-repair":ze,"prompt-duel":Te,"boss-battle":Le,"daily-mission":qe,"peer-challenge":Se};z.addRoute("/",()=>{if(!y.isPlacementDone()){z.navigate("/placement");return}y.updateStreak(),re(O)});z.addRoute("/placement",()=>{de(O)});z.addRoute("/world/:id",e=>{let t=parseInt(e.id);t>=1&&t<=4?le(O,t):z.navigate("/")});z.addRoute("/game/:type/:worldId/:levelId",e=>{let t=e.type,n=parseInt(e.worldId),l=parseInt(e.levelId),i=We[t];i?i(O,n,l):z.navigate("/")});z.addRoute("/glossary",()=>{ce(O)});z.addRoute("/review",()=>{me(O)});z.addRoute("/profile",()=>{he(O)});z.start();
